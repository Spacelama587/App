...
import { collection, doc, getDoc, getDocs, limit, query, serverTimestamp, Timestamp, updateDoc, where, orderBy, loadBundle, } from 'firebase/firestore';
...
const Detail = ({setActive, user}) => {
  ...
  useEffect(() =>{
    const getRecentBlogs = async () => {
      ...
      const recentBlogs = query(blogRef, 
          ...
          <div className='row mx-0'>
            ...
            <div className='blog-heading text-start py-2 mb-4'>Tags</div>
              ...
              <div className='custombox'>
                ...
                {isEmpty(comments) ? (
                  <UserComments msg={"Bet the First To Comment"}/>
                ): (
                  <>
